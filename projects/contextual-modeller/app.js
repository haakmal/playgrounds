  ...
  flow: {
    ...
    steps: [
      ...
      [
        ...
        "Connect roles according to evidence and label significant exchanges.",
      ],
      [
        "Identify dependencies",
        "Ask what each role is waiting for and who or what they depend upon.",
      ],
      [
        "Mark breakdowns",
      ...
      [
        "Check the evidence",
        "For each major connection ask: where did we observe or hear this?",
      ],
    ],
  },
  sequence: {
    ...
    steps: [
      ...
      [
        ...
        "Include actions, decisions, repetitions, interruptions and strategies.",
      ],
      [
        "Find workarounds",
        "Retain shortcuts and adaptations rather than simplifying them away.",
      ],
      [
        "Mark breakdowns",
        "Identify where activity becomes difficult, repeats or changes direction.",
      ],
      [
        "Check the evidence",
        "Separate what was observed or heard from what was inferred.",
      ],
    ],
  },
  cultural: {
    ...
    steps: [
      [
        "Identify the focus",
        "Choose the role or activity whose behaviour you are trying to understand.",
      ],
      [
        "Identify influences",
      ...
      [
        "Connect influence to behaviour",
        "Show how an influence appears to affect what happens.",
      ],
      [
        "Find competing influences",
        "Look for expectations pulling behaviour in different directions.",
      ],
      [
        "Identify power and control",
        "Ask who controls decisions, access, information or resources.",
      ],
      [
        "Check the evidence",
        "What behaviour or statement demonstrates that this influence matters?",
      ],
    ],
  },
  physical: {
    ...
    steps: [
      [
        ...
        "Focus on the space in which the relevant activity occurs.",
      ],
      [
        "Draw the basic layout",
        "Represent only spatial elements important to the activity.",
      ],
      [
        "Add movement",
        "Map routes, stopping points, congestion and repeated movement.",
      ],
      [
        "Add environmental conditions",
        "Note visibility, noise, privacy, proximity and access where relevant.",
      ],
      [
        "Identify adaptations",
        "Show how people alter or work around the environment.",
      ],
      [
        "Mark spatial friction",
        "Identify delay, interruption, restricted access or unwanted exposure.",
      ],
      [
        "Check observed behaviour",
        "What did people actually do because of this spatial condition?",
      ],
    ],
  },
  artefact: {
    ...
    steps: [
      [
        "Select an artefact",
        "Choose one that appears repeatedly or is important in the evidence.",
      ],
      ["Represent its structure", "Draw or reproduce only the relevant parts."],
      [
        "Identify information",
        "What does it tell the person and how is information organised?",
      ],
      [
        "Identify requirements",
        "What does it require the person to enter, remember, select or interpret?",
      ],
      [
        "Identify constraints",
        "What does it make difficult, mandatory, easy or invisible?",
      ],
      [
        "Find adaptations",
        "Look for annotation, rewriting, bypassing or use of another tool.",
      ],
      [
        "Identify assumptions",
        "What does it appear to assume about user, situation or task?",
      ],
      [
        "Check actual use",
        "Model how it was actually used, not only its intended function.",
      ],
    ],
  },
};
const groups = [
  ...
  {
    id: "breakdowns",
    label: "Breakdowns or workarounds were especially visible",
    model: null,
    detail: [],
  },
];
const scenarioEvidence = {
  ...
  cultural: [
    ...
    [
      "E3",
      "Students commonly ask peers for quick help before approaching staff.",
    ],
    ["E4", "Staff are responsible for resolving printing account issues."],
    [
      "E5",
      "The student prioritises speed over reading all available instructions.",
    ],
  ],
  physical: [
    ...
    [
      "E4",
      "The payment terminal is positioned beside, rather than directly facing, the printer screen.",
    ],
  ...
  artefact: [
    ...
    [
      "E3",
      "A printed instruction sheet uses different terminology from the screen.",
    ],
...
function bindExampleModal() {
  document.querySelector("[data-example-back]").onclick = () => {
    ...
    document.querySelector("#modalBody").innerHTML = exampleModalHtml(
      state.exampleKey,
    );
    document.querySelector("#modalFooter").innerHTML =
...
function render() {
  ...
  if (state.screen === 0) {
    ...
    const evidenceCount = [...state.selected].filter(
      (id) => id !== "unsure",
    ).length;
    ...
    bindChoices();
    next.textContent =
      evidenceCount < 2 ? "Select at least 2 →" : "Look closer →";
    ...
    let html =
      '<p class="lead">Select all statements that are supported by your collected evidence.</p>';
    ...
    score();
    let prompts = state.recommended.slice(0, 3).map(
      (k, i) =>
        ({
          flow: "Who appears to depend on whom? What moves between them?",
          sequence:
            "Where does the activity change direction, repeat or break down?",
          cultural:
            "What seems to influence behaviour beyond the immediate task?",
          physical:
            "What did people do differently because of the environment?",
          artefact:
            "What did the tool or artefact make easier, harder or necessary?",
    ...
    if (evidenceCount < 2) {
      ...
      document
        .querySelector("#reviewEvidenceBtn")
    ...
    document
      ...
      .forEach((b) => (b.onclick = () => openExample(b.dataset.example)));
    ...
    document.querySelector("#modelExampleBtn").onclick = () =>
      openExample(state.guide);
