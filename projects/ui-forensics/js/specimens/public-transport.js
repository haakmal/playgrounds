export function render(root) {
  ...
  root
    .querySelector("#s28-select")
    .addEventListener("click", () =>
      root.querySelector(".route-card").classList.add("active"),
    );
  root.querySelector("#s28-compare").addEventListener("click", () => {
    root.querySelectorAll(".route-card")[0].classList.remove("active");
    root.querySelector("#s28-message").hidden = false;
  });
}
