export function render(root) {
  ...
  root
    .querySelector("#s40-now")
    .addEventListener(
      "click",
      () => (root.querySelector("#s40-warning").hidden = false),
    );
  root.querySelector("#s40-schedule").addEventListener("click", (e) => {
    e.preventDefault();
    root.querySelector("#s40-warning").textContent = "Update scheduled";
    root.querySelector("#s40-warning").hidden = false;
  });
}
