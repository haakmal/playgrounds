export function render(root) {
  ...
  root.querySelector("#s38-back").addEventListener("click", () => {
    form.hidden = true;
    summary.hidden = false;
  });
  root.querySelector("#s38-forward").addEventListener("click", () => {
    form.hidden = false;
    summary.hidden = true;
  });
  root
    .querySelector("#s38-submit")
    .addEventListener(
      "click",
      () => (root.querySelector("#s38-reason").value = ""),
    );
}
