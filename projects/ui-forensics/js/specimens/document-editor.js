export function render(root) {
  ...
  root.querySelector("#s25-bold").addEventListener("click", () => {
    root.querySelector("#s25-bold").classList.add("active");
    text.style.fontWeight = "700";
    root.querySelector("#s25-save-state").textContent = "Saved";
  });
  root.querySelector("#s25-italic").addEventListener("click", () => {
    text.style.fontStyle = "italic";
    root.querySelector("#s25-italic").classList.add("active");
    root.querySelector("#s25-save-state").textContent = "Saved";
  });
  root.querySelector("#s25-undo").addEventListener("click", () => {
    root.querySelector("#s25-bold").classList.remove("active");
    root.querySelector("#s25-italic").classList.remove("active");
