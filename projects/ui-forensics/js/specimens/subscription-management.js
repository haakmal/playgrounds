export function render(root) {
  ...
  root.querySelector("#s30-downgrade").addEventListener("click", (e) => {
    e.preventDefault();
    root.querySelector("#s30-steps").hidden = false;
  });
  root
    .querySelector("#s30-confirm")
    .addEventListener(
      "click",
      () =>
        (root.querySelector("#s30-steps").innerHTML +=
          '<p class="specimen-muted">Please confirm again to continue.</p>'),
    );
}
