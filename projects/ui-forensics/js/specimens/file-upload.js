export function render(root) {
  ...
  root.querySelector("#s12-choose").addEventListener("click", () => {
    root.querySelector("#s12-progress").hidden = false;
    setTimeout(() => (root.querySelector("#s12-done").hidden = false), 1100);
  });
}
