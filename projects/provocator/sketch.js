...
function onSliderChange() {
  ...
  sliderValues["temporal"] = parseInt(
    document.getElementById("temporal").value,
  );
  sliderValues["obscurity"] = parseInt(
    document.getElementById("obscurity").value,
  );
  sliderValues["human"] = parseInt(document.getElementById("human").value);
  sliderValues["optimism"] = parseInt(
    document.getElementById("optimism").value,
  );
  sliderValues["disruption"] = parseInt(
